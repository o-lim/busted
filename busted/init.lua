local function init(busted)
  ...
  busted.export_api('publish', busted.publish)
  busted.export_api('subscribe', busted.subscribe)
  busted.export_api('unsubscribe', busted.unsubscribe)

  busted.export_api('bindfenv', busted.bindfenv)
  busted.export_api('fail', busted.fail)
  busted.export_api('parent', busted.context.parent)
  busted.export_api('version', busted.version)
